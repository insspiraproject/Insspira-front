...
export const reports: Report[] = [
  {
    ...
    reportedBy: "u_002",
    reason: "copyright",
    details: "Possible unauthorized use of image.",
...
export const adminPlans: Plan[] = [
  {
    ...
    pricePerMonth: 0,
    currency: "USD",
    features: ["Limited uploads", "Public profile"],
    isActive: true,
  ...
  },
  {
    ...
    pricePerMonth: 9.99,
    currency: "USD",
    features: ["Unlimited uploads", "Basic analytics", "Private folders"],
    isActive: true,
    createdAt: "2024-01-01",
  },
  {
    ...
    pricePerMonth: 14.99,
    currency: "USD",
    features: ["All Pro features", "Advanced analytics", "Priority discovery"],
    isActive: true,
  ...
  },
  {
    ...
    pricePerMonth: 29.99,
    currency: "USD",
    features: ["Teams", "SSO", "Dedicated support"],
    isActive: false,
