...
//   return (
//     <div className="h-[450px] w-[250px] mt-8 ">
//       <img
//         src={pin.image}
//         alt={pin.description || "Pin image"}
//         className="w-[250px] h-[400px] opacity-80 rounded-t-xl 
//         hover:opacity-100 hover:shadow-xl hover:shadow-gray-500"
//       />
//       <div className="flex flex-col text-xs bg-[var(--color-rosa)] p-2 rounded-b-xl mb-8">
